...
Что бы отказаться от рассылки -  введите ответ - off";
        ...
        break;
    case '33';
        $message = "<p>1.БЕЛГОРОД:</p>
<p>SK-0.5-NEW (1400руб) - ответ - 501 </p>
<p>KRISS-0.5NEW (1400руб) - ответ - 521 </p>
<p>KRISS-1-NEW (2200руб) - ответ - 531 </p>
<p>ROKK-ROLL 1.4NEW (2300руб) - ответ - 551</p> 
<p>ROKK-ROLL0.7NEW (1200руб) - ответ - 561</p> 
<p>Crystal Shtorm 05 (1500руб) - ответ - 611 </p>
<p>Belgorod ROYAL SPEED 05g (1700руб) - ответ - 911 </p>
<br>
<p>2.г.ОБОЯНЬ:</p>
<p>г.Обоянь -SK-0.5NEW  (1400руб) - ответ - 592 </p>
<p>г. ОБОЯНЬ  KR-05-NEW (1400руб) - ответ - 772 </p>
<br>
<p>3.г. ШЕБЕКИНО:</p>
<p>г.ШЕБЕКЕНО KRISS- 0.5  (1500руб) - ответ - 623</p> 
<p>г.ШЕБЕКЕНО SK-0.5-NEW  (1300руб) - ответ - 643 </p>
<br>
<p>5.г.СТРОИТЕЛЬ:</p>
<p>г.Строитель KR-05-NEW (1500руб) - ответ - 845 </p>
<p>г.Строитель SK-05-NEW (1500руб) - ответ - 855 </p>
<p>г.Строитель SK-1gr-NEW (2400руб) - ответ - 935 </p>
<p>г.Строитель KR-1gr-NEW (2400руб) - ответ - 945 </p>
<br>
<p>Сделайте выбор и введите соответствующий номер </p>
<br>
<p>Что бы отказаться от рассылки -  введите ответ - off</p>";
        sendMessage($token, $id, $message);
        break;
    default:
        $message = 'Что бы заказать товар - отправьте сообщение цифрами 55 или нажмите кнопку "ВЫБРАТЬ ТОВАР"
